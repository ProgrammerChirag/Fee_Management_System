//F:\Chirag Juneja\New folder\Fee_management_system
...
public class Fee_management_system {
    ...
    void addFees(String str, int id) {
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            StringBuffer query = new StringBuffer();
            query.append("UPDATE login SET fee = ");
            query.append(str);
    ...
    void Login_page(int id) {
        ...
        submit.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Fee_management_system f = new Fee_management_system();
                if ((name.getText().isEmpty()) || (father.getText().isEmpty()) || (mother.getText().isEmpty())
                        || (Phone.getText().isEmpty()) || (amount.getText().isEmpty()) || (batch.getText().isEmpty())) {
                    ...
                    try {
                        ...
                        StringBuffer query = new StringBuffer();
                        query.append("select name from login where id =");
                        query.append(String.valueOf(id));
                        query.append(";");
                        String q1 = new String(query);
                        System.out.println(q1);
                        ...
                        rs.next();
                        name = rs.getString(1);
                        f.addLast(Integer.parseInt(amount.getText()), id, name);
        ...
        Generate.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                ...
                if (!(na.isEmpty()) && !(fat.isEmpty()) && !(moth.isEmpty()) && !(pho.isEmpty()) && !(amo.isEmpty())
                        && !(batch.getText().isEmpty())) {
                    a.setText(null);
                    a.append("==========================MITRC==========================\n");
                    a.append("\n\n\n");
                    a.append("=========================================================\n");
    ...
    void addLast(int am, int id, String name) {
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            StringBuffer query = new StringBuffer();
            String q1;
    ...
    void LoginDataBase(int i, String name, String pass, JFrame j) {
        String password;
        StringBuffer query = new StringBuffer();
        // C:\chiragjuneja\mysql-connector-java-5.0.8-bin.jar;.;
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
